...
class ExpensesHistoryScreenTest {

    @get:Rule
    val composeTestRule = createComposeRule()

    @Test
    fun testExpensesHistoryTitleDisplayed() {
        composeTestRule.setContent {
            // Mock ExpensesHistoryScreen content
        }

        composeTestRule.onNodeWithText("История расходов").assertIsDisplayed()
    }
